...
"""Gemma3 image preprocessing utilities.

Based on google-deepmind/gemma multimodal/image.py
"""
...
def normalize_images(
    images: jaxtyping.Float[jaxtyping.Array, "H W C"],
...
def pre_process_image(
    image: jaxtyping.Float[jaxtyping.Array, "H W C"],
    *,
...
def patchify_images(
    images: jaxtyping.Float[jaxtyping.Array, "B H W C"],
    patch_size: int = _DEFAULT_PATCH_SIZE,
    padding: str = "VALID",
) -> jaxtyping.Float[jaxtyping.Array, "P D"]:
...
def load_image_files(
    ...
    patch_size: int = _DEFAULT_PATCH_SIZE,
) -> jaxtyping.Float[jaxtyping.Array, "B S P D"] | None:
  """Loads image files.
  ...
  Returns:
    ...
    patch size * patch_size * channels]
  """
